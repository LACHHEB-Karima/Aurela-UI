            ...
            <div className="flex flex-col gap-4 lg:flex-row gap-10">
                    ...
                    <div className="flex flex-col gap-4">
                        {product.images.slice(0, 4).map(img => (
                            <img
                                ...
                                className={`w-20 h-auto border cursor-pointer ${mainImage === img.url ? "border-black" : "border-gray-300"
                                    }`}
                            />
                        ))}
                    </div>
                ...
                <div className="flex-1">
                    ...
                    <button onClick={handleAdd} disabled={product.stock === 0}
                        className={`text-center py-3 px-6 text-sm mb-6 ${product.stock === 0 ? "bg-gray-300 cursor-not-allowed" : "bg-black text-white"
